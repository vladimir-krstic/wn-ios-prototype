...
| [presentationDetents](https://developer.apple.com/documentation/swiftui/view/presentationdetents(_:selection:)) | Native medium and large sheet heights with controlled selection | Expanding a compact input sheet when the keyboard is used | Onboarding, profile switcher, Chat Relays | 2026-08-10 |
