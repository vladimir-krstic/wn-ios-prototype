...
| [DragGesture](https://developer.apple.com/documentation/swiftui/draggesture) | Native continuous drag values for direct manipulation | Tracking the approved horizontal message swipe-to-reply and vertical composer-expansion interactions | Conversation | 2026-08-14 |
