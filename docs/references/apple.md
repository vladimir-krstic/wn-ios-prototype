...
| [UIContextMenuInteraction](https://developer.apple.com/documentation/uikit/uicontextmenuinteraction) | UIKit ownership of contextual menu interaction and action delivery | Coordinating the compact attachment menu without recreating its surface | Conversation | 2026-08-11 |
| [UIContextMenuInteractionDelegate](https://developer.apple.com/documentation/uikit/uicontextmenuinteractiondelegate) | Menu display-begin and display-end lifecycle callbacks | Preventing the attachment menu's bottom row from activating the composer beneath it | Conversation | 2026-08-11 |
...
| [LongPressGesture](https://developer.apple.com/documentation/swiftui/longpressgesture) | Native recognition after a minimum hold duration and within an allowable movement distance | Requiring deliberate press-and-hold activation | Conversation voice recording | 2026-08-11 |
| [onLongPressGesture](https://developer.apple.com/documentation/swiftui/view/onlongpressgesture(minimumduration:maximumdistance:perform:onpressingchanged:)) | SwiftUI long-press defaults and press-state callbacks | Applying native hold timing and pressed feedback to a custom control | Conversation voice recording | 2026-08-11 |
...
| [safeAreaBar](https://developer.apple.com/documentation/swiftui/view/safeareabar(edge:alignment:spacing:content:)) | Stationary actions beside scrolling content | Installing a system-owned bottom action bar | Chats, Sign Up, Profile, Chat Info media preview | 2026-08-10 |
