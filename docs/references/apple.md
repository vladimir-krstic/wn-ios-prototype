...
| [safeAreaBar](https://developer.apple.com/documentation/swiftui/view/safeareabar(edge:alignment:spacing:content:)) | Stationary actions beside scrolling content with matching safe-area and scroll-edge effects | Installing a system-owned bottom action bar or conversation composer | Chats, conversation, Sign Up, Profile, Chat Info media preview | 2026-08-12 |
