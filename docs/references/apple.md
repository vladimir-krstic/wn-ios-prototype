...
| [Search fields](https://developer.apple.com/design/human-interface-guidelines/search-fields) | Search-field purpose, placement, prompts, and immediate results | Adding search over an image or content collection | Chats, Sign Up | 2026-08-07 |
| [Search modifiers](https://developer.apple.com/documentation/swiftui/view-search) | Native search presentation and activation | Adding searchable content | Chats, Sign Up | 2026-08-07 |
| [Adding a search interface](https://developer.apple.com/documentation/swiftui/adding-a-search-interface-to-your-app) | Search placement, suggestions, scopes, and programmatic state | Implementing a complete SwiftUI search experience | Chats, Sign Up | 2026-08-07 |
