...
| [Privacy](https://developer.apple.com/design/human-interface-guidelines/privacy) | Contextual permission requests, data-use transparency, and recovery | Requesting protected access or explaining external data sharing before it occurs | QR scanning, profile media, Sign Up web-image search, diagnostics consent | 2026-08-20 |
| [App Review Guidelines: Privacy](https://developer.apple.com/app-store/review/guidelines/#privacy) | Consent for anonymous usage data, data minimization, and accessible withdrawal | Adding optional analytics or another data-collection choice | Diagnostics & Improvements | 2026-08-20 |
...
| [Sheets](https://developer.apple.com/design/human-interface-guidelines/sheets) | Scoped modal tasks, system-owned geometry, and interactive dismissal | Deciding whether work belongs in a native sheet | Sign In, Sign Up, diagnostics choices, switcher, destructive confirmation, conversation camera and media viewer | 2026-08-20 |
...
| [presentationDetents](https://developer.apple.com/documentation/swiftui/view/presentationdetents(_:selection:)) | Native medium and large sheet heights with controlled selection | Choosing a sheet's supported resting heights | Onboarding, diagnostics choices, profile switcher, Chat Relays, conversation media viewer | 2026-08-20 |
...
| Source | Governs | Open when | Current areas | Verified |
| --- | --- | --- | --- | --- |
| [Settings](https://developer.apple.com/design/human-interface-guidelines/settings) | Settings hierarchy, restraint, and system preference respect | Adding or reorganizing a preference | Settings, Developer Tools, Diagnostics & Improvements | 2026-08-20 |
...
| [fileExporter](https://developer.apple.com/documentation/swiftui/view/fileexporter(ispresented:document:contenttype:defaultfilename:oncompletion:)) | System destination picker for exported files | Saving a private-key, encrypted-backup document, shared chat media, or diagnostic report without a custom browser | Profile Keys, Chat Info media preview, Developer Tools | 2026-08-20 |
| [FileDocument](https://developer.apple.com/documentation/swiftui/filedocument) | Value-type serialization for exported documents | Preparing deterministic content for `fileExporter` | Profile Keys, Chat Info media preview, Developer Tools | 2026-08-20 |
